...
class KelasController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('pages.admin.kelas.create', compact('data'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.admin.kelas.edit', compact('data', 'kelas'));
    }
    ...
    public function destroy($id)
    {
        ...
        $kelas->delete();
        return redirect()->route('kelas.index')->with('success', 'Berhasil Menhapus Kelas');
    }
}
