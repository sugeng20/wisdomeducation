...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('faq.create') }}" class="btn btn-primary"><i class="mdi mdi-plus-circle"></i>
                        Tambah FAQ
                    </a>
                        ...
                        <table class="table" id="table-datatables">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('faq.edit', $item->id) }}" title="Edit"
                                            class="btn btn-warning btn-sm"><i class="mdi mdi-square-edit-outline"></i>
                                        </a>

                                        <form class="d-inline" action="{{ route('faq.destroy', $item->id) }}"
