            ...
            <div class="page-title-box">
                <div class="float-end">
                    <ol class="breadcrumb">
                        ...
                        <!--end nav-item-->
                        <li class="breadcrumb-item"><a href="#">Tambah Wadah Kreasi</a>
                        </li>

                    </ol>
                </div>
                <h4 class="page-title">Tambah Wadah Kreasi</h4>
            </div>
            <!--end page-title-box-->
        </div>
        <!--end col-->
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('wadah-kreasi.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="nama_ide" id="nama_ide" class="form-control"
                                    placeholder="Masukan Nama Ide" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="link" id="" cols="30" rows="2" class="form-control"
                                    placeholder="Masukan Link PPT"></textarea>
                            </div>
                        </div>
