...
<div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="float-end">
                    <ol class="breadcrumb">
                        ...
                        <!--end nav-item-->
                        <li class="breadcrumb-item"><a href="#">Wadah Kreasi</a>
                        </li>
                    </ol>
                </div>
                <h4 class="page-title">Wadah Kreasi</h4>
            </div>
            <!--end page-title-box-->
        </div>
        <!--end col-->
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('wadah-kreasi.create') }}" class="btn btn-primary"><i
                        ...
                        <table class="table" id="table-datatables">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th>
                                        {{ $item->guru ? $item->guru->nama_guru : 'Admin' }}
                                    </th>
                                    <td>
                                        <a href="{{ route('wadah-kreasi.edit', $item->id) }}" title="Edit"
                                            class="btn btn-warning btn-sm"><i class="mdi mdi-square-edit-outline"></i>
                                        </a>

                                        <form class="d-inline" action="{{ route('wadah-kreasi.destroy', $item->id) }}"
