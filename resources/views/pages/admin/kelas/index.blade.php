...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('kelas.create') }}" class="btn btn-primary"><i class="mdi mdi-plus-circle"></i>
                        Tambah Kelas
                    </a>
                    ...
                    <div class="table-responsive">
                        <table class="table" id="table-datatables">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $no++ }}</td>
                                    <td>{{ $item->mataPelajaran->nama_matpel }}</td>
                                    ...
                                    <td>
                                        ...
                                        <form class="d-inline" action="{{ route('kelas.destroy', $item->id) }}"
