        ...
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-md-6 col-lg-5">
                <div class="hero-animation-img">
                    <img class="img-fluid d-block m-auto animation-one" src="{{ asset('frontend/img/bg-child.png') }}"
                        width="420" alt="animation image">

                    <img class="img-fluid d-none d-lg-block animation-three"
                        src="{{ asset('frontend/img/hero-animation-01.svg') }}" alt="animation image" width="70">
                    <img class="img-fluid d-none d-lg-block animation-four"
                        src="{{ asset('frontend/img/hero-animation-03.svg') }}" alt="animation image" width="50">
                </div>
            </div>
        </div>
    </div>
